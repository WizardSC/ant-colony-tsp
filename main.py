...
def main():
    #Tổng thời gian thực hiện sau xx lần chạy
    total_execution_time = 0 
    #Tổng chi phí sau xx lần chạy
    total_cost = 0 
    #Chi phí tốt nhất: khởi tạo ban đầu là vô cực
    best_cost = float('inf') 
    #Đường đi tốt nhất: ban đầu là None
    best_path = None 
